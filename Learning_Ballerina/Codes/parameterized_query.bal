...
returns sql:Error? {
    ...
    io:println("Create table executed: ", result);}function insertSingleRecord(jdbc:Client jdbcClient) {
    ...
    sql:ExecutionResult|sql:Error result =
        jdbcClient->execute(insertQuery);    if (result is sql:ExecutionResult) {
